...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Building infrastructure. Empowering communities. Mending the future." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "/" },
      { property: "og:image", content: hero },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Sthololwazi Projects — Civil & Building Construction" },
      { name: "twitter:description", content: "100% black-owned, B-BBEE Level 1 contractor in Mpumalanga." },
    ...
    <SiteLayout>
        ...
        <div className="relative container-page pb-20 pt-40 w-full">
          <div className="max-w-3xl text-white">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <Link to="/services" className="btn-ghost text-white border-white/30 hover:bg-white/10 hover:!text-white hover:!border-white">
                Our services
              </Link>
            </div>
        ...
        <div className="grid gap-16 md:grid-cols-12 items-start">
          <div className="md:col-span-5">
            ...
            <h2 className="display-lg mt-6">
              Not a contractor. An <span className="italic-accent">infrastructure & social</span> development partner.
            </h2>
          </div>
      ...
      <section className="bg-onyx text-white py-28 md:py-36">
        <div className="container-page">
          <div className="flex items-end justify-between gap-8 flex-wrap mb-16">
            <div>
              <div className="text-[11px] uppercase tracking-[0.22em] text-gold font-semibold">Track record</div>
              <h2 className="display-lg mt-5 text-white max-w-2xl">From a single classroom block to 500 homes delivered.</h2>
            </div>
            <Link to="/projects" className="btn-ghost text-white border-white/25 hover:!text-white hover:!border-white hover:bg-white/10">
              View all projects →
            </Link>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              { img: rdp, t: "500 RDP Houses", d: "National housing delivery, project management", v: "R 53,000,000" },
              { img: hospital, t: "Evander Hospital", d: "Renovation works", v: "R 70,000" },
              { img: school, t: "Tholinhlanhla Primary School", d: "Renovation works", v: "R 97,000" },
            ].map((p) => (
      ...
      <section className="container-page py-28 md:py-40">
        <div className="grid gap-12 md:grid-cols-12 items-center">
          <div className="md:col-span-5">
            ...
            <h2 className="display-lg mt-6">Master craft. <span className="italic-accent">Local knowledge.</span></h2>
            <p className="mt-8 text-[15px] leading-[1.75] text-muted-foreground">
          ...
          <div className="md:col-span-6 md:col-start-7 grid grid-cols-2 gap-4">
            <img src={foreman} alt="Site foreman" width={1024} height={1280} loading="lazy" className="rounded-xl object-cover aspect-[3/4] w-full" />
            <div className="space-y-4">
              <div className="rounded-xl bg-forest text-white p-6">
                <div className="font-display text-5xl font-light leading-none">135<span className="text-2xl align-top">%</span></div>
                <div className="mt-3 text-xs uppercase tracking-[0.18em] text-white/70">Procurement recognition</div>
              </div>
              <div className="rounded-xl bg-gold-light p-6">
                <div className="font-display text-5xl font-light leading-none text-onyx">Zero</div>
                <div className="mt-3 text-xs uppercase tracking-[0.18em] text-onyx/70">Harm site policy</div>
              </div>
              <div className="rounded-xl border border-border p-6">
                <div className="font-mono text-xs text-gold">CIDB 10127071</div>
                <div className="mt-2 text-sm text-muted-foreground">Construction Industry Development Board registered.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl bg-forest text-white p-12 md:p-20 relative overflow-hidden">
          ...
          <div className="relative max-w-2xl">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <a href="tel:+27646204247" className="btn-ghost text-white border-white/30 hover:!text-white hover:!border-white hover:bg-white/10">
                064 620 4247
              </a>
            </div>
          </div>
